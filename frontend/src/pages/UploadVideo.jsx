...
function UploadVideo() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-4 sm:p-8 flex justify-center items-center">
      <div className="max-w-2xl w-full bg-gray-800 p-6 sm:p-8 rounded-lg shadow-lg">
