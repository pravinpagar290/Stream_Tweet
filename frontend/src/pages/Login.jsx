...
import { useAuth } from '../Auth/AuthContext'; // Corrected path assumption
...
function Login() {
  ...
  const { setUser, setIsLoggedIn } = useAuth(); // Make sure useAuth provides these
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Assuming your API returns { data: { user: {...} } }
      if (response.data && response.data.data && response.data.data.user) {
        // We set the user object and login state in our context
